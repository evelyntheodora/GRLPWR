...
struct ReflectionView3: View {
    @State var selectedReflection3 = true
    var body: some View {
        NavigationView{
            ZStack{
                Color("yellow")
...
struct RadioButton3<Tag, CircleButton, Label>: View
...
struct RadioButtonGroup3<Tag, CircleButton, Label>: View
where Tag : Hashable, CircleButton : View, Label : View {
  @Binding var selection: Tag?
  ...
  @ViewBuilder private var radioButtons: some View {
    ForEach(tags, id: \.self) { tag in
      RadioButton3(tag: tag, selection: $selection, button: button) {
        label(tag)
      }
    }
  }
...
struct RadioButtonTest3: View {
  @State private var selection: Option?

  var body: some View {
    VStack {
      RadioButtonGroup3(selection: $selection,
...
struct ReflectionView3_Previews: PreviewProvider {
